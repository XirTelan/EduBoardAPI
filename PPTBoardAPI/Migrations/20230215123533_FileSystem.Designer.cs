...
namespace PPTBoardAPI.Migrations
{
    ...
    [Migration("20230215123533_FileSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PPTBoardAPI.Authentication.Person", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PPTBoardAPI.Entities.Attendance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PPTBoardAPI.Entities.FileSystemObj", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PPTBoardAPI.Authentication.Person", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PPTBoardAPI.Entities.Attendance", b =>
                {
                    b.HasOne("PPTBoardAPI.Entities.Student", "Student")
            ...
            modelBuilder.Entity("PPTBoardAPI.Entities.ControllRecord", b =>
                {
                    b.HasOne("PPTBoardAPI.Entities.ControllType", "ControllType")
                        .WithMany()
                        .HasForeignKey("ControllTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PPTBoardAPI.Entities.FileSystemObj", b =>
                {
                    b.HasOne("PPTBoardAPI.Entities.FileSystemObj", "ParentFolder")
                        .WithMany()
            ...
            modelBuilder.Entity("PPTBoardAPI.Entities.Group", b =>
                {
                    b.HasOne("PPTBoardAPI.Authentication.Person", "Person")
                        .WithMany("Groups")
