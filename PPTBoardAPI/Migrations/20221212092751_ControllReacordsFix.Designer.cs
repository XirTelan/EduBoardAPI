...
namespace PPTBoardAPI.Migrations
{
    ...
    [Migration("20221212092751_ControllReacordsFix")]
    partial class ControllReacordsFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PPTBoardAPI.DTOs.Person", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PPTBoardAPI.DTOs.Person", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PPTBoardAPI.Entities.Group", b =>
                {
                    b.HasOne("PPTBoardAPI.DTOs.Person", "Person")
                        .WithMany("Groups")
